...
def create_tiny_yolo_solver(args):#for region proposal and later it called as proposal_net
      
  solver = caffe.get_solver('models/tiny_solver.prototxt')
  #solver.restore('backup/yolo_mobile_iter_357000.solverstate')
  return solver

def create_recognizer_solver(args):#for recognition and later it named as recog
