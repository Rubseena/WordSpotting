...
def draw_box_points(img, points, color = (0, 255, 0), thickness = 1):
  ...
  try:
      #cv2.line(img,start_point,end_point,clr,thickness) start_point=(xmin,ymin) and end_point=(xmax,ymax)
...
0    cv2.line(img, (points[0][0], points[0][1]), (points[3][0], points[3][1]), color, thickness)
  except:
    pass
